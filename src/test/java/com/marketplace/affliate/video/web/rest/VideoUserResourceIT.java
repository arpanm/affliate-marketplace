...
class VideoUserResourceIT {
    ...
    private static final String DEFAULT_EMAIL = ":@\\_Z";
    private static final String UPDATED_EMAIL = "QSR@\\`U8k";
    ...
    void partialUpdateVideoUserWithPatch() throws Exception {
        ...
        partialUpdatedVideoUser.isBlocked(UPDATED_IS_BLOCKED).isActive(UPDATED_IS_ACTIVE).updatedOn(UPDATED_UPDATED_ON);
