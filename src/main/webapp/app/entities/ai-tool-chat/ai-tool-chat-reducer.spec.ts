...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AITOOLCHAT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AITOOLCHAT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AITOOLCHAT actions', async () => {
      const arg = { id: 22280 };
    ...
    it('dispatches UPDATE_AITOOLCHAT actions', async () => {
      const arg = { id: 22280 };
    ...
    it('dispatches PARTIAL_UPDATE_AITOOLCHAT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AITOOLCHAT actions', async () => {
      const arg = 42666;
