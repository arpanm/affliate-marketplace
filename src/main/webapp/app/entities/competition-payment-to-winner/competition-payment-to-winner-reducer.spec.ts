...
import reducer, {
  ...
  reset,
  updateEntity,
} from './competition-payment-to-winner.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETITIONPAYMENTTOWINNER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPETITIONPAYMENTTOWINNER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPETITIONPAYMENTTOWINNER actions', async () => {
      const arg = { id: 20901 };
    ...
    it('dispatches UPDATE_COMPETITIONPAYMENTTOWINNER actions', async () => {
      const arg = { id: 20901 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPETITIONPAYMENTTOWINNER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPETITIONPAYMENTTOWINNER actions', async () => {
      const arg = 42666;
