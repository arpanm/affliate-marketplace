...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BANKDETAILS_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BANKDETAILS actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BANKDETAILS actions', async () => {
      const arg = { id: 15871 };
    ...
    it('dispatches UPDATE_BANKDETAILS actions', async () => {
      const arg = { id: 15871 };
    ...
    it('dispatches PARTIAL_UPDATE_BANKDETAILS actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BANKDETAILS actions', async () => {
      const arg = 42666;
