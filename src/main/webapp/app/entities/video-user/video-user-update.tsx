...
export const VideoUserUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    const entity = {
      ...
      company: sponsors.find(it => it.id.toString() === values.company?.toString()),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          affinityVectors: videoUserEntity?.affinityVectors?.map(e => e.id.toString()),
          company: videoUserEntity?.company?.id,
        };
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('affliateMarketplaceApp.videoUser.affinityVectors')}
                id="video-user-affinityVectors"
              ...
              <ValidatedField
                id="video-user-company"
                name="company"
                data-cy="company"
                label={translate('affliateMarketplaceApp.videoUser.company')}
                type="select"
              >
                <option value="" key="0" />
                {sponsors
