...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VIDEOUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VIDEOUSER actions', async () => {
      const arg = { id: 13692 };
    ...
    it('dispatches UPDATE_VIDEOUSER actions', async () => {
      const arg = { id: 13692 };
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VIDEOUSER actions', async () => {
      const arg = 42666;
