...
import reducer, {
  ...
  reset,
  updateEntity,
} from './competition-payment-from-sponsor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETITIONPAYMENTFROMSPONSOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPETITIONPAYMENTFROMSPONSOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPETITIONPAYMENTFROMSPONSOR actions', async () => {
      const arg = { id: 24898 };
    ...
    it('dispatches UPDATE_COMPETITIONPAYMENTFROMSPONSOR actions', async () => {
      const arg = { id: 24898 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPETITIONPAYMENTFROMSPONSOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPETITIONPAYMENTFROMSPONSOR actions', async () => {
      const arg = 42666;
