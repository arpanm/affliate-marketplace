...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './review.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REVIEW_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REVIEW actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REVIEW actions', async () => {
      const arg = { id: 8996 };
    ...
    it('dispatches UPDATE_REVIEW actions', async () => {
      const arg = { id: 8996 };
    ...
    it('dispatches PARTIAL_UPDATE_REVIEW actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REVIEW actions', async () => {
      const arg = 42666;
