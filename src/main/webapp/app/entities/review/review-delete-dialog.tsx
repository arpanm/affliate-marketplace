...
import { deleteEntity, getEntity } from './review.reducer';
...
export const ReviewDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="affliateMarketplaceApp.review.delete.question">
        <Translate contentKey="affliateMarketplaceApp.review.delete.question" interpolate={{ id: reviewEntity.id }}>
