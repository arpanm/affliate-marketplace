...
export const ContactDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="affliateMarketplaceApp.contact.delete.question">
        <Translate contentKey="affliateMarketplaceApp.contact.delete.question" interpolate={{ id: contactEntity.id }}>
