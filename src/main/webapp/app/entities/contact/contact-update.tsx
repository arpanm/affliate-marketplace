...
export const ContactUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    const entity = {
      ...
      receiver: videoUsers.find(it => it.id.toString() === values.receiver?.toString()),
    };
  ...
  const defaultValues = () =>
    isNew
      ...
      : {
          ...
          receiver: contactEntity?.receiver?.id,
        };
          ...
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                ...
                name="receiver"
                data-cy="receiver"
                label={translate('affliateMarketplaceApp.contact.receiver')}
                type="select"
              >
                <option value="" key="0" />
                {videoUsers
