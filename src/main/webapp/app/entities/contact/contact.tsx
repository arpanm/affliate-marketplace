          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="affliateMarketplaceApp.contact.receiver">Receiver</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {contactList.map((contact, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{contact.receiver ? <Link to={`/video-user/${contact.receiver.id}`}>{contact.receiver.id}</Link> : ''}</td>
