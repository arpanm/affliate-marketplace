...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AITOOLPAYMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AITOOLPAYMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AITOOLPAYMENT actions', async () => {
      const arg = { id: 31560 };
    ...
    it('dispatches UPDATE_AITOOLPAYMENT actions', async () => {
      const arg = { id: 31560 };
    ...
    it('dispatches PARTIAL_UPDATE_AITOOLPAYMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AITOOLPAYMENT actions', async () => {
      const arg = 42666;
