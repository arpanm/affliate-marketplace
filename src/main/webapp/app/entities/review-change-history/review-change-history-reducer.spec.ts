...
import reducer, {
  ...
  reset,
  updateEntity,
} from './review-change-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REVIEWCHANGEHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REVIEWCHANGEHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REVIEWCHANGEHISTORY actions', async () => {
      const arg = { id: 9575 };
    ...
    it('dispatches UPDATE_REVIEWCHANGEHISTORY actions', async () => {
      const arg = { id: 9575 };
    ...
    it('dispatches PARTIAL_UPDATE_REVIEWCHANGEHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REVIEWCHANGEHISTORY actions', async () => {
      const arg = 42666;
