...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './affinity.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AFFINITY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AFFINITY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AFFINITY actions', async () => {
      const arg = { id: 32666 };
    ...
    it('dispatches UPDATE_AFFINITY actions', async () => {
      const arg = { id: 32666 };
    ...
    it('dispatches PARTIAL_UPDATE_AFFINITY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AFFINITY actions', async () => {
      const arg = 42666;
