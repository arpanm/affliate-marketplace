...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './video-tag.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOTAG_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VIDEOTAG actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VIDEOTAG actions', async () => {
      const arg = { id: 18797 };
    ...
    it('dispatches UPDATE_VIDEOTAG actions', async () => {
      const arg = { id: 18797 };
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOTAG actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VIDEOTAG actions', async () => {
      const arg = 42666;
