...
import reducer, {
  ...
  reset,
  updateEntity,
} from './competition-winner.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETITIONWINNER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPETITIONWINNER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPETITIONWINNER actions', async () => {
      const arg = { id: 4903 };
    ...
    it('dispatches UPDATE_COMPETITIONWINNER actions', async () => {
      const arg = { id: 4903 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPETITIONWINNER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPETITIONWINNER actions', async () => {
      const arg = 42666;
