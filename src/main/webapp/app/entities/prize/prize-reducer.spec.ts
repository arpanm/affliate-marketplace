...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './prize.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRIZE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRIZE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRIZE actions', async () => {
      const arg = { id: 31911 };
    ...
    it('dispatches UPDATE_PRIZE actions', async () => {
      const arg = { id: 31911 };
    ...
    it('dispatches PARTIAL_UPDATE_PRIZE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRIZE actions', async () => {
      const arg = 42666;
