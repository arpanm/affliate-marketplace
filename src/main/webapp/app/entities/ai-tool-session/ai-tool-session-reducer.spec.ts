...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AITOOLSESSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AITOOLSESSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AITOOLSESSION actions', async () => {
      const arg = { id: 25734 };
    ...
    it('dispatches UPDATE_AITOOLSESSION actions', async () => {
      const arg = { id: 25734 };
    ...
    it('dispatches PARTIAL_UPDATE_AITOOLSESSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AITOOLSESSION actions', async () => {
      const arg = 42666;
