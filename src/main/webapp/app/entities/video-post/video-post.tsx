          ...
          <Table responsive>
            <thead>
              <tr>
                ...
                <th>
                  <Translate contentKey="affliateMarketplaceApp.videoPost.competition">Competition</Translate>{' '}
                ...
                <th>
                  <Translate contentKey="affliateMarketplaceApp.videoPost.affinityVectors">Affinity Vectors</Translate>{' '}
                  <FontAwesomeIcon icon="sort" />
                </th>
                <th>
            ...
            <tbody>
              {videoPostList.map((videoPost, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>
                    {videoPost.competition ? <Link to={`/competition/${videoPost.competition.id}`}>{videoPost.competition.id}</Link> : ''}
                  </td>
                  <td>
                    {videoPost.tags
                  ...
                  <td>
                    {videoPost.affinityVectors
                      ? videoPost.affinityVectors.map((val, j) => (
                          <span key={j}>
                            <Link to={`/affinity/${val.id}`}>{val.id}</Link>
                            {j === videoPost.affinityVectors.length - 1 ? '' : ', '}
                          </span>
                        ))
                      : null}
                  </td>
