    ...
    <Row>
      <Col md="8">
        ...
        <dl className="jh-entity-details">
          ...
          <dd>{videoPostEntity.competition ? videoPostEntity.competition.id : ''}</dd>
          <dt>
          ...
          <dd>
            {videoPostEntity.affinityVectors
              ? videoPostEntity.affinityVectors.map((val, i) => (
                  <span key={val.id}>
                    <a>{val.id}</a>
                    {videoPostEntity.affinityVectors && i === videoPostEntity.affinityVectors.length - 1 ? '' : ', '}
                  </span>
                ))
              : null}
          </dd>
