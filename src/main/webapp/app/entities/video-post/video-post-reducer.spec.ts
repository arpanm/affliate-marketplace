...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOPOST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VIDEOPOST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VIDEOPOST actions', async () => {
      const arg = { id: 5903 };
    ...
    it('dispatches UPDATE_VIDEOPOST actions', async () => {
      const arg = { id: 5903 };
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOPOST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VIDEOPOST actions', async () => {
      const arg = 42666;
