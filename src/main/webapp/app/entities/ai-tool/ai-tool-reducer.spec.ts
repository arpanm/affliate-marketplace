...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './ai-tool.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_AITOOL_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_AITOOL actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_AITOOL actions', async () => {
      const arg = { id: 9948 };
    ...
    it('dispatches UPDATE_AITOOL actions', async () => {
      const arg = { id: 9948 };
    ...
    it('dispatches PARTIAL_UPDATE_AITOOL actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_AITOOL actions', async () => {
      const arg = 42666;
