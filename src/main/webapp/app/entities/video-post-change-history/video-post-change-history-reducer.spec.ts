...
import reducer, {
  ...
  reset,
  updateEntity,
} from './video-post-change-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_VIDEOPOSTCHANGEHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_VIDEOPOSTCHANGEHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_VIDEOPOSTCHANGEHISTORY actions', async () => {
      const arg = { id: 27325 };
    ...
    it('dispatches UPDATE_VIDEOPOSTCHANGEHISTORY actions', async () => {
      const arg = { id: 27325 };
    ...
    it('dispatches PARTIAL_UPDATE_VIDEOPOSTCHANGEHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_VIDEOPOSTCHANGEHISTORY actions', async () => {
      const arg = 42666;
