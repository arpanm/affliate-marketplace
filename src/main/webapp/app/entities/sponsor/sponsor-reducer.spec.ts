...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './sponsor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SPONSOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SPONSOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SPONSOR actions', async () => {
      const arg = { id: 27573 };
    ...
    it('dispatches UPDATE_SPONSOR actions', async () => {
      const arg = { id: 27573 };
    ...
    it('dispatches PARTIAL_UPDATE_SPONSOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SPONSOR actions', async () => {
      const arg = 42666;
