...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COMPETITION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_COMPETITION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_COMPETITION actions', async () => {
      const arg = { id: 25923 };
    ...
    it('dispatches UPDATE_COMPETITION actions', async () => {
      const arg = { id: 25923 };
    ...
    it('dispatches PARTIAL_UPDATE_COMPETITION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_COMPETITION actions', async () => {
      const arg = 42666;
